<template>
    <div class="main">
        ...
        <img v-show="show3" style="width: 500px;right: 10px;top: 1200px;"
            src="https://suola-1300285550.cos.ap-nanjing.myqcloud.com/wedding/others/wh1.jpg" />
        <img v-show="show1" style="width: 560px;right: 10px;top: 20px;"
            src="https://suola-1300285550.cos.ap-nanjing.myqcloud.com/wedding/others/wh2.jpg" />
        <img v-show="show2" style="width: 300px;right: 10px;top: 580px;"
            src="https://suola-1300285550.cos.ap-nanjing.myqcloud.com/wedding/others/zjs1.jpg" />
        <img v-show="show4" style="right: 10px;top: 1990px;" src="@/assets/images/icon/goBack.png" @click="goBack()">
    </div>
</template>
